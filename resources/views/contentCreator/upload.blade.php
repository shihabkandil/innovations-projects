...
<link href="https://unpkg.com/tailwindcss@^2/dist/tailwind.min.css" rel="stylesheet">
  ...
  <div class="py-20 h-screen bg-gray-300 px-2">
    <div class="max-w-md mx-auto bg-white rounded-lg overflow-hidden md:max-w-lg">
        <div class="md:flex">
            <div class="w-full">
                <div class="p-4 border-b-2"> <span class="text-lg font-bold text-gray-600">Request Adding Content</span> </div>
                <div class="p-3">
                    ...
                    <div class="mb-2"> <span>Attachments</span>
                        <select class="form-select h-12 p-2 w-50 border-gray-200 border rounded focus:outline-none focus:border-gray-300">
                            <option value="1" selected>Course Content</option>
    ...
    <script src="{{asset('js/uploadContent.js')}}"></script>
